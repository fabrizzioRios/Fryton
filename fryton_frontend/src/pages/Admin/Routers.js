...
import {HeaderPage, TableRouters, AddEditRouterForm, AddEditSwitchForm} from "../../components/Admin";
    ...
    return (
        <>
            ...
            {loading ?(
                ...
                <TableRouters routers={routers} updateRouter={updateRouter} onDeleteRouter={onDeleteRouter}/>
            )}
            <ModalBasic
                show={showModal}
                title={titleModal}
